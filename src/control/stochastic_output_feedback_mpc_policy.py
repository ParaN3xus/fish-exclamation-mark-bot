...
class StochasticOutputFeedbackMPCPolicy(TimeOptimalBangBangPolicy):
    ...
    def __init__(
        ...
        is_vr: bool = False,
        initial_difficulty_estimate: float = 9.0,
        progress_ref: float = 0.3850648101883916,
        hard_start: float = 4.177904549548225,
        hard_span: float = 3.4803894403218716,
        danger_hard_gain: float = 0.0,
        conservative_danger_floor: float = 0.5813913381544923,
        conservative_danger_hard_gain: float = 0.09127670257515547,
        hard_nominal_threshold: float = 0.45570955643043537,
        conservative_weight_base: float = 0.5168340247420233,
        conservative_weight_hard_gain: float = 0.7474518676262424,
        tie_margin_base: float = 0.00040575444130761494,
        tie_margin_danger_gain: float = 0.02497396897737947,
        tie_margin_hard_reduction: float = 0.907801824174996,
    ) -> None:
        super().__init__(

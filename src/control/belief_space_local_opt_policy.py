...
class BeliefSpaceLocalOptPolicy(TimeOptimalBangBangPolicy):
    ...
    def __init__(
        ...
        is_vr: bool = False,
        initial_difficulty_estimate: float = 8.94070509290397,
        horizon_base_seconds: float = 0.31533703941068014,
        horizon_danger_seconds: float = 0.3362716787357089,
        q_var_init: float = 0.0015332239160703639,
        q_process_noise_per_second: float = 0.0001863425015799019,
        q_jump_noise_gain: float = 4.201625224384098,
        q_stability_decay: float = 0.9881165763540884,
        uncertainty_threshold_gain: float = 0.7050408063293347,
        risk_worst_weight_base: float = 0.8337274806003268,
        risk_worst_weight_danger_gain: float = 0.6597362256567417,
        target_bias_base: float = 0.16064240030114413,
        target_bias_danger_gain: float = 0.18056706033574096,
        recovery_band_base: float = 2.5993433601094713,
        recovery_band_danger_gain: float = 2.8626832878006043,

...
class TimeOptimalBangBangPolicy(Policy):
    ...
    def __init__(
        ...
        is_vr: bool = False,
        initial_difficulty_estimate: float = 8.474087297947523,
        difficulty_up_blend: float = 0.33500063409119885,
        difficulty_down_blend: float = 0.0,
        robust_horizon_base_seconds: float = 0.18978002353685572,
        robust_horizon_danger_seconds: float = 0.0909451224188163,
        robust_horizon_min_steps: int = 15,
        robust_horizon_max_steps: int = 32,
        robust_risk_base: float = 0.4626750957343869,
        robust_risk_danger_gain: float = 0.28206562243054617,
        robust_risk_dnorm_gain: float = 0.12868313147617572,
        robust_risk_max: float = 0.995,
        danger_progress_ref: float = 0.6602973874509106,
        target_bias_base: float = 0.16944335229864754,
        target_bias_danger_gain: float = 0.02415348192036168,
        recovery_band_base: float = 2.1784627272289225,
        recovery_band_danger_gain: float = 0.8007614046986803,
        safe_band_base: float = 0.7760812503379693,
        safe_band_danger_gain: float = 0.10733411504029197,
        one_step_override_danger_threshold: float = 0.19661486969520112,
        robust_eval_difficulty_threshold: float = 4.69573392150742,
